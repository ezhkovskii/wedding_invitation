...
window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
    ...
    var e = !!document.querySelector(".t706"), t = !!document.querySelector(".js-payment-systembox"),
    ...
    for (var e, r, o = t.querySelectorAll(".js-tilda-rule"), a = [], n = !0, i = 0; i < o.length; i++) {
        var s = o[i], l = !!parseInt(s.getAttribute("data-tilda-req") || 0, 10),
            d = s.getAttribute("data-tilda-rule") || "none", c = "", u = "",
            m = s.getAttribute("data-tilda-rule-minlength") || 0, p = s.getAttribute("data-tilda-rule-maxlength") || 0,
            f = {}, _ = s.value, y = "", w = s.getAttribute("type"), h = s.getAttribute("name"),
        ...
        var b = !_.length && !y.length, w = "checkbox" === w || "radio" === w,
            h = !t.querySelectorAll('[name="' + h + '"]:checked').length;
        if (l && (b || w && h)) f.type.push("req"); else {
            switch (d) {
                case "email":
                ...
                case "url":
                    ...
                    break;
                case "phone":
                    var v = s.getAttribute("data-tilda-mask"), E = "^[0-9()+-";
    ...
    return "y" === g && (e = void 0 !== window.tcart_minorder && 0 < window.tcart_minorder, r = void 0 !== window.tcart_mincntorder && 0 < window.tcart_mincntorder, e && window.tcart.prodamount < window.tcart_minorder && ((f = {
        ...
        obj: {},
        type: []
    }).type.push("minquantity"), a.push(f))), n && !a.length && (a = [{obj: "none", type: ["emptyfill"]}]), a
    ...
    var r, o = t.getAttribute("id"), a = (a = t.getAttribute("data-inputbox")) || ".blockinput", n = "", i = !1, s = "",
        l = "", d = "", c = document.getElementById("tilda-popup-for-error");
    ...
    for (var u, m, p = 0; p < e.length; p++) if (e[p] && e[p].obj) {
        if (0 === p && "none" === e[p].obj) {
        ...
        for (var _ = 0; _ < e[p].type.length; _++) {
            var y = e[p].type[_], w = t_forms__getMsg(y), l = "";
    ...
    for (var r = (r = t.getAttribute("data-inputbox")) || ".blockinput", o = "", a = !1, n = "", i = "", s = "", l = 0; l < e.length; l++) if (e[l] && e[l].obj) {
        if (0 === l && "none" === e[l].obj) {
        ...
        for (d = 0; d < e[l].type.length; d++) {
            var u = e[l].type[d], s = "";
            if (1, (n = t.querySelectorAll(".js-rule-error-" + u)).length) for (var m = 0; m < n.length; m++) n[m].getAttribute("data-rule-filled") || (n[m].textContent && n[m].innerText || !t_forms__getMsg(u) ? s = n[0].textContent || n[0].innerText : n[m].innerHTML = t_forms__getMsg(u)), n[m].style.display = "block"; else if (t_forms__getMsg(u) && (n = t.querySelectorAll(".js-rule-error-all")).length) for (m = 0; m < n.length; m++) n[m].innerHTML = t_forms__getMsg(u), n[m].style.display = "block";
    ...
    t instanceof Element || (t = t[0]);
    var r, o = document.getElementById("tildaformcaptchabox"), a = document.getElementById("js-tildaspec-captcha");
    ...
    var e = "", r = document.getElementById("tildaformsuccesspopup"),
        o = document.getElementById("tildaformsuccesspopuptext"), a = document.body;
    ...
    var successBox = form.querySelector(".js-successbox"), successStr = t_forms__getMsg("success"), dataSuccessMessage;
    ...
    var allRecords = document.getElementById("allrecords"), pageId = allRecords.getAttribute("data-tilda-page-id"),
    ...
    if (inputItsGood || form.insertAdjacentHTML("beforeend", '<div style="position: absolute; left: -5000px; bottom: 0; display: none;"><input type="text" name="form-spec-comments" value="Its good" class="js-form-spec-comments" tabindex="-1" /></div>'), 2 === formType || !formType && formKey) {
        ...
        //formUrl
        return xhr.open("POST", "", !0), xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), xhr.setRequestHeader("Accept", "application/json, text/javascript, */*; q=0.01"), xhr.onreadystatechange = function () {
            if (4 === 4) if (200 <= 200 < 400) { //xhr.status && xhr.status
                var data = "{\"message\":\"OK\"}"; //xhr.responseText;
                if (data) {
                    ...
                    if ("object" == typeof objData) {
                        ...
                        if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0", objData && objData.error) {
                            ...
                            var formResult = {}, strValue, strValue;
                            ...
                            var dataEventName = form.getAttribute("data-tilda-event-name") || "",
                                ...
                                title = "Send data from form " + formId, price = 0, product = "",
    ...
    return xhr.open("POST", form.getAttribute("action"), !0), xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), xhr.setRequestHeader("Accept", "text/plain, */*; q=0.01"), xhr.onreadystatechange = function () {
        if (4 === xhr.readyState) if (200 <= xhr.status && xhr.status < 400) {
            var t = form.querySelector(".js-successbox"), e = form.getAttribute("data-success-url"),
                r = form.getAttribute("data-success-callback");
            if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0", l = xhr.responseText) if ("{" == l.substring(0, 1)) {
                var o = JSON.parse(l);
                if ("object" == typeof o) if (o && o.message && "OK" !== o.message) t.innerHTML = o.message; else if (o && o.error) {
            ...
            var i = "/tilda/" + formId + "/submitted/", t = "Send data from form " + formId;
            ...
            var s, a = (s = t_forms__getErrorContainers(form, "")).errorBoxes, n = s.allError, l = xhr.responseText;
            Array.prototype.forEach.call(n, function (t) {
...
function t_forms__addPlaceholder(t) {
    var e = (t = t || window.event).target || t.srcElement, r = e.closest("[data-input-lid]"), t = "";
        ...
        if (o) {
            ...
            if (r.tildaSendingStatus && (t = r.tildaSendingStatus), !(t && 1 <= t || t_hasClass(r, "t706__submit_disable"))) {
                ...
                if (!o.querySelectorAll(".js-formaction-services").length && 1 !== e && !t) {
                    var n = t_forms__getErrorContainers(o, ""), i = n.errorBoxes, n = n.allError;
                    return Array.prototype.forEach.call(n, function (t) {
...
function t_forms__onSuccess(t) {
    ...
    var e = t.closest(".r"), r = e.getAttribute("data-record-type"), o = t.querySelector(".t-form__inputsbox"),
        a = getComputedStyle(o, null), n = parseInt(a.paddingTop) || 0, i = parseInt(a.paddingBottom) || 0,
        s = o.clientHeight - (n + i) + (o.getBoundingClientRect().top + window.pageYOffset),
        l = t.querySelector(".t-form__successbox").getBoundingClientRect().top + window.pageYOffset, d = 0,
        a = window.innerHeight, n = document.body, i = document.documentElement,
    ...
    var c = "t" + r + "__inputsbox_hidden", u = [702, 708, 862, 945, 1014], m = !0,
        d = 960 < window.innerWidth ? l - 200 : l - 100, p = document.querySelector(".t-tildalabel");
    if (l > window.scrollY || n - s < a - 100) o.classList.add(c), n < a && p && setTimeout(function () {
        t_fadeOut(p)
    }, 300); else {
        for (var f = 0; f < u.length; f++) if (u[f] == r) {
            m = !1;
            break
        }
...
function t_forms__scrollBeginForm(t) {
    var r = 400,
        ...
        a = t - o, n = 0, i = 16;
    document.body.setAttribute("data-scrollable", "true"), function t() {
        var e;
...
Array.prototype.some || (Array.prototype.some = function (t) {
    ...
    t.matches = t.matchesSelector = e || function (t) {
        var e = document.querySelectorAll(t), r = this;
...
function t_serializeArray(t) {
    for (var e = [], r = t.querySelectorAll("input, textarea, button, select"), o = 0; o < r.length; o++) if (!(!r[o].name || r[o].disabled || -1 < ["file", "reset", "submit", "button"].indexOf(r[o].type))) if ("select-multiple" !== r[o].type) -1 < ["checkbox", "radio"].indexOf(r[o].type) && !r[o].checked || e.push({
        name: r[o].name,
        value: r[o].value
    }); else for (var a = r[o].options, n = 0; n < a.length; n++) a[n].selected && e.push({
        name: a[n].name,
        value: a[n].value
    });
    return e
