...
function t_zeroForms__renderForm(t, e, r, o) {
    ...
    var n = document.querySelector(".t-records"),
        n = (n = !!n && "edit" === n.getAttribute("data--mode")) || "published" !== o;
...
function t_zeroForms__createForm(e, t, r, o) {
    ...
    var l, d, i = document.createElement("div"),
        ...
        _ = t_zeroForms__getTildaMode(), u = 0;
...
function t_zeroForms__updateStylesOnResize(t, e) {
    var r = t_zeroForms__createFormObj(e), o = e.getAttribute("data-elem-id"), n = e.querySelector(".t-form"),
        ...
        a = e.querySelectorAll(".t-input-inline-styles"), l = (Array.prototype.forEach.call(a, function (t) {
...
function t_zeroForms__parseIntoElement(e, r, o, n, t, i) {
    ...
    var a, s, l = n.inputmargbottom ? "margin-bottom:" + n.inputmargbottom + "px;" : "",
        ...
        m = {fontSize: n.inputelsfontsize || "", fontWeight: c || ""}, p = {
            name: o.li_nm,
            placeholder: o.li_ph || "",
...
function t_zeroForms__createRadio(i, a, s, l) {
    var t = i.li_variants ? i.li_variants.split("\n") : [], d = "cb" === i.li_radcb, c = parseInt(i.li_defselitem, 10),
...
function t_zeroForms__generateBtnStyles(t, e, r, o, n) {
    var t = t_zeroForms__generateButtonStyles(o, window.getComputedStyle(t).fontFamily),
        o = t_zeroForms__generateButtonHoverStyles(o), i = document.getElementById("t-uploadcare-zero-form"),
        a = document.getElementById("t-upwidget-zero-form"), s = t_zeroForms__createSelector(e, r, ""),
        ...
        s = "t-zero-form-btn-styles-" + r + "-" + e, t = document.getElementById(s);
...
function t_zeroForms__generateButtonStyles(t, e) {
    var r, o = {
        ...
        "background-color": t.buttonbgcolor || "transparent",
...
function t_zeroForms__isFormOutside(t) {
    ...
    var i = (i = e.classList.contains("t396__artboard_scale")) || "window" === t_zeroForms__getFieldValue(e, "data-artboard", "upscale"),
        ...
        i = (a = "number" == typeof (a = a && a.indexOf("px") ? parseInt(a, 10) : a) ? a : 0, i && !e && (o *= window.tn_scale_factor, a *= window.tn_scale_factor), t.hasAttribute("data-animate-fix")),
...
function t_zeroForms__getFieldValue(e, r, o) {
    if (e && void 0 !== window.tn) {
        var n = t_zeroForms__getResOpts(e.closest(".t396__artboard")), i = "data-field" === r ? "-value" : "",
...
function t_zeroForms__getResOpts(t) {
    ...
    return t && window.tn["ab" + t] ? {
        ...
        breakpoints: window.tn["ab" + t].screens.slice(0, -1).reverse()
    } : window.tn.screens ? {
        res: window.tn.curResolution,
        resMax: window.tn.topResolution,
        breakpoints: window.tn.screens.slice(0, -1).reverse()
    } : {res: window.tn.curResolution, resMax: 1200, breakpoints: [960, 640, 480, 320]}
}
...
function t_zeroForms__fromObjToArray(t) {
    var e = void 0 !== Object.values, r = e ? Object.values(t) : [];
    if (!e) for (var o in t) r.push(t[o]);
    return r
}

function t_zeroForms__updateCheckboxesValues() {
    var t = this.closest("[data-input-lid]"), e = Array.prototype.slice.call(t.querySelectorAll(".t-checkbox:checked")),
        r = "", e = (e.forEach(function (t) {
            r && (r += "; "), r += t.value
